          ...
          >
            ...
            <SingleCollection.DescriptionWrapper>
              ...
              <SingleCollection.CollectionName
                dangerouslySetInnerHTML={ { __html: collection[ index ].data.collection_name[ 0 ].text } }/>
              <SingleCollection.ArtName
                dangerouslySetInnerHTML={ { __html: collection[ index ].data.name[ 0 ].text } }/>
...
Collection.getInitialProps = async({ query }) => {
  ...
  const collection = await API.query(Prismic.Predicates.at('my.collection.uid', query.collection), { lang: 'fr-FR' }).then(async res => {
