...
const LegalPage = () => (
  <div className="legal-container">
    <div className="wrapper-text">
      MENTIONS LÉGALES
      En vigueur au ________________

      Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance
      dans l’économie
      numérique, dite L.C.E.N., il est porté à la connaissance des Utilisateurs du site ________________ les
      présentes
      mentions légales.
    ...
    ARTICLE 4 : COLLECTE DES DONNÉES
      ...
      vie privée
      conformément à la loi n°78-17 du 6 janvier 1978 relative à l'informatique, aux fichiers et aux libertés. Le
      site
